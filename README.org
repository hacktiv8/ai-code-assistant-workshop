...
[[file:/Users/riza/code/ai-coding-assistant-workshop/screenshots/claude.png][contoh AI chatbot claude]]
...
[[file:/Users/riza/code/ai-coding-assistant-workshop/screenshots/completion.png][contoh code completion dengan vscode]]
...
- lovable.dev: Aplikasi yang mampu membuat aplikasi fullstack.

Berikut contoh tangkapan layar dari v0.
[[file:/Users/riza/code/ai-coding-assistant-workshop/screenshots/v0.png][Tangkapan layar v0]]
...
[[file:/Users/riza/code/ai-coding-assistant-workshop/screenshots/claude.png][Contoh brainstorming ide dengan claude]]
...
Hasilnya bisa disimpan kedalam dokumen teks seperti ~spec.md~ misalnya. Berikut contoh spesifikasi yang dihasilkan oleh ChatGPT.
...
[[file:/Users/riza/code/ai-coding-assistant-workshop/screenshots/deepseek-r1.png][Mengaktifkan fitur berfikir panjang di deepseek]]
...
Pengalaman pribadi sejauh ini, jika teknologi yang digunakan butuh integrasi manual seperti project berbasis nodejs dengan backend Express/Hono ditambah database apapun, seringkali mengalami kesulitan. Selalu ada saja kesalahan atau /error/ yang seharusnya tidak perlu terjadi.
...
TODO Contoh ~spec.md~
TODO Screenshot salah satu iterasi di vscode
...
Pertama lakukan satu pengujian secara manual, lalu minta AI untuk menambahkan. Berdasarkan pengalaman, kalau kita minta AI bikin pengujian dari nol, kadang justru banyak /ngelantur/. Karenanya, mending kita buatkan satu /test case/ sebagai contoh terus biarkan AI membuatkan kasus-kasus lain.
...
Apabila hasil dokumentasinya ngaco? Kalaulah asisten ngoding berbasis AI, yang sudah dilatih dengan milyaran baris kode di luar sana, masih nggak paham juga dengan kodingan kita, kira-kira yang ngaco siapa ya? Mungkin ini adalah peringatan dini buat kita bahwa kodingan kita kurang dapat dimengerti dan harus segera diperbaiki atau disederhanakan 😉
...
Contoh nyata: ada bagian yang diulang-ulang. Sejatinya ini dipisahkan jadi fungsi tersendiri. Pas banget untuk minta bantuan AI!
...
Pastikan teman-teman memahami sepenuhnya kode yang disarankan tersebut sebelum menerima solusinya atau copas ke code editor. Jika kesulitan memahami solusi yang diberikan, tanyakan kembali maksud dari baris kode yang diberikan itu apa. Karena ketika kode sudah masuk kedalam proyek, maka kode buatan AI tadi adalah tanggungjawab kita. Ngga mungkin kan ketika terjadi kesalahan kita menyalahkan AI?!
